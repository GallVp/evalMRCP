...
summary(pnModel)
Anova(pnModel)
lsmeans(pnModel, pairwise ~ sysName | mvName, adjust = "tukey")
```
...
summary(pntModel)
Anova(pntModel)
lsmeans(pntModel, pairwise ~ sysName | mvName, adjust = "tukey")
```
...
summary(pmnModel)
Anova(pmnModel)
lsmeans(pmnModel, pairwise ~ sysName | mvName, adjust = "tukey")
```
...
summary(snrModel)
Anova(snrModel)
lsmeans(snrModel, pairwise ~ sysName | mvName, adjust = "tukey")
```